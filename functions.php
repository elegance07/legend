...
define('DT_VERSION', '4.0.3');
define('DT_THEME_NAME', 'Grifus');
define( 'DT_KEY', 'edd_sample_theme_license_key_status');
define( 'EDD_SL_STORE_URL', '' ); /*IMPORTANTE: no modifique esta linea el theme podria dejar de funcionar correctamente*/
...
$shadow = trim( get_option( 'edd_sample_theme_license_key' ) );
...
<tbody>
<tr valign="top">
<h4><center>Please enter "<font color="green">www.nulled.ch</font>" as license key and click "Activate License".</center></h4>
...
<td>
<?php if( $status !== false && $status == 'www.nulled.ch' ) { ?>
...
$license_data->license =		 'www.nulled.ch';
$license_data->item_name =		 $plugin_slug;
$license_data->expires =		 '2050-01-01 00:00:00';
$license_data->payment_id =	 	 0;
$license_data->customer_name =	 'Shadow';
$license_data->customer_email =	 'shadownf@tuta.io';
...
$license_data->expires =		 '2050-01-01 00:00:00';
$license_data->payment_id =	 	 0;
$license_data->customer_name =	 'FREENULLED';
$license_data->customer_email =	 'freenulled@babiato.net';
$license_data->license_limit =	 0;
$license_data->site_count =		 0;
$license_data->activations_left =	 'unlimited';
...
<div id="form_episodes" class="form_post_data">
	<form id="generate" class="generador_form">
		<input type="text" id="imdb" name="se" placeholder="ID TMDb" required="">
		<input type="number" id="season" name="te" placeholder="Season" required="">
		<input id="generate_episode" class="button button-primary button-large" type="submit" value="Import episodes">
	</form>
	<p id="msg"><?php _e('Tool to generate all episodes of a specific season.','mundothemes'); ?></p>
</div>
<script>
jQuery(document).ready(function(){
    jQuery('#generate').submit(function(){
        jQuery('#msg').html("<span class='loading'></span>  <?php _e('Please wait, loading data...','mundothemes'); ?>");
